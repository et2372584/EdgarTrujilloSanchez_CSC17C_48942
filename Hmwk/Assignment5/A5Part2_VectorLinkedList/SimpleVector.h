...
// Copy Constructor
template <class T>
SimpleVector<T>::SimpleVector(const SimpleVector &firstList)
{
...
template <class T>
void SimpleVector<T> :: push(T input)
{
...
template <class T>
void SimpleVector<T> :: append(T input)
{
	push(input);
}
...
template <class T>
void SimpleVector<T> :: prepend(T input)
{
	// Declaring temporary pointer
	Node *prependPush;
...
template <class T>
void SimpleVector<T> :: extract(T value)
{
...
template <class T>
void SimpleVector<T> :: insertBefore(T gvalue, T input)
{
	// Temporary traverse pointers
	Node *traverse1=root;
...
template <class T>
void SimpleVector<T> :: insertAfter(T gvalue, T input)
{
	// Temporary traverse pointers
	Node *traverse1=root;
...
// list into another linked list
template <class T>
void SimpleVector<T> :: copyList(const SimpleVector &gList)
{
	Node *traverse1;
	Node *traverse2;
...
// Overloaded = (Assignment) Operator
template <class T>
SimpleVector<T> &SimpleVector<T> :: operator= (const SimpleVector &gList)
{
